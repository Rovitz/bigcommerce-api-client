...
class PriceListsApi extends ResourceApi
{
    ...
    public function create(object $data): PriceListResponse
    {
        return new PriceListResponse($this->createResource($data));
    }

    public function update(object $data): PriceListResponse
    {
        return new PriceListResponse($this->updateResource($data));
    }
